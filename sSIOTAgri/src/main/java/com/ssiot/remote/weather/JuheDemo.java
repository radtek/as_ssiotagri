...
public class JuheDemo {
	...
	// 配置您申请的KEY
	public static final String APPKEY = "6b686638aeaec6d3d2e3ee91fcb698c3";

	// 1.根据城市查询天气
	public static void getRequest1() {
		String result = null;
		String url = "http://op.juhe.cn/onebox/weather/query";// 请求接口地址
																// //http://www.juhe.cn/docs/api/id/73
		...
		try {
			...
			JSONObject object = new JSONObject(result);// JSONObject.fromObject(result);
